...
main = 
  do args <- getArgs
     ...
     if args !! 4 /= "yuh" then mapM_ (\i -> writeImage (args !! 4 ++ show i ++ ".png") (interpImages (1.0/45.0*fromIntegral i) img tringle1 img2 tringle2) >> putStrLn ("Wrote " ++ show i)) [22] else return ()
     void getLine  
